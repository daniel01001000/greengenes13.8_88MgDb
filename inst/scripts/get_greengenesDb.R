### =========================================================================
### Downloading database greengenes 13_8 88 OTU database
...
getGreenGenes13.8.88Db <- function(
        db_name = "gg_13_8_OTU88",
        seq_url = "ftp://greengenes.microbio.me/greengenes_release/gg_13_8_otus/rep_set/88_otus.fasta",
        taxa_url = "ftp://greengenes.microbio.me/greengenes_release/gg_13_8_otus/taxonomy/88_otu_taxonomy.txt",
        tree_url = "ftp://greengenes.microbio.me/greengenes_release/gg_13_8_otus/trees/88_otus.tree"
){
